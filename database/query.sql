...
select emails_persons.id, persons.id, first_name, last_name from persons join emails_persons on emails_persons.person_id=persons.id where emails_persons.id = 1
union
