...
class WAIT_FOR_CLUBS_INSERT_INVITE_CLUB_MEMBER_SCREEN extends State
{
		...
		if (owner.mData)
				...
				//remove all old options
                                ...
                                owner.mStateMachine.changeState(owner.mWAIT_FOR_SUBMIT_INSERT_INVITE_CLUB_MEMBER_SCREEN);
                        }
                        if (owner.mCode == -113)
                        {
...
class WAIT_FOR_SUBMIT_INSERT_INVITE_CLUB_MEMBER_SCREEN extends State
{
        constructor()
        {
                super();
        ...
        enter(owner)
        {
                if (owner.mStateLogs || owner.mStateEnterLogs)
                {
                        console.log("WAIT_FOR_SUBMIT_INSERT_INVITE_CLUB_MEMBER_SCREEN: ENTER");
                }
        }
        ...
        exit(owner)
        {
                if (owner.mStateLogs || owner.mStateExitLogs)
                {
                        console.log("WAIT_FOR_SUBMIT_INSERT_INVITE_CLUB_MEMBER_SCREEN: EXIT");
                }
        }
}
