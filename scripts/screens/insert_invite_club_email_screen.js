	...
	constructor(application)
	{
		...
		document.getElementById("insertinviteclubemailscreenbuttonid").onclick = this.hit.bind(this);
                ...
                this.setSpinner(document.getElementById("insert_invite_club_email_screen_spinner_id"));
							 //insert_invite_club_email_screen_spinner_id
	}
		...
		this.mHit = true;
      		...
      		var email  = document.getElementById("insert_invite_club_email_screen_email_id").value;
                ...
                if (club_select.length > 0 && person_select.length > 0)
                {
                        ...
                        APPLICATION.getCurrentScreen().setUrl("/php/classes/screens/insert_invite_club_email.php?jwt=" + APPLICATION.getJWT() + '&club_id=' + club_id + '&person_id=' + person_id + '&email=' + email);
