...
class InsertGoogleLoginClub 
{
	function __construct() 
	{
		...
		$prepare_result = pg_prepare($database->mConnection, "f_insert_google_login_club", $sql);
	...
	$insertGoogleLoginClub = new InsertGoogleLoginClub();	
?>
