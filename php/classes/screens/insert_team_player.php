	...
	function getResult()
        {
                ...
                $result = pg_execute($this->mDatabase->mConnection, "f_insert_team_player", array( $this->getSenderEmailId(), $this->mPersonId, $this->mScreenPersonId, $this->mTeamId, $this->mClubId));
