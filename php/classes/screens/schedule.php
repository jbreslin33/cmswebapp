...
class ScheduleScreen extends Screen
{
	...
	function getResult()
	{
                ...
                $sql = 'select f_select_events($1,$2,$3,$4,$5)';
                $prepare_result = pg_prepare($this->mDatabase->mConnection, "f_select_events", $sql);
		$result = pg_execute($this->mDatabase->mConnection, "f_select_events", array( $this->getSenderEmailId(), $this->mFamilyId, $this->mPersonId, $first_day_of_query, $last_day_of_query));
