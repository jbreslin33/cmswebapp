...
class TeamGameAvailabilityScreen extends Screen
{
	...
	function getResult()
	{
                $sql = 'select f_select_team_game_availability($1,$2,$3)';
                $prepare_result = pg_prepare($this->mDatabase->mConnection, "f_select_team_game_availability", $sql);
		$result = pg_execute($this->mDatabase->mConnection, "f_select_team_game_availability", array( $this->getSenderEmailId(), $this->mPersonId, $this->mGameId));
