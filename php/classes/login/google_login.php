...
class GoogleLogin
{
        function __construct($email,$google_id,$id_token,$first_name,$last_name,$club_invite_token)
        {
	...
	if (isset($_GET['club_invite_token']))
	{
        ...
        $googleLogin = new GoogleLogin($email,$google_id,$id_token,$first_name,$last_name,$club_invite_token);
?>
