...
class ScheduleQuery extends Query
{
	...
	{
		$this->mQuery = "
			select affairs_users_availability.id, affair_date, arrival_time, start_time, end_time, affairs.address, affairs.coordinates, pitches.name, field_name, teams.name, affair_types.name, availability.id
			from affairs
